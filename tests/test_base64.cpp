...
TEST_CASE( "Base64", "[default]" )
{
   ...
   SECTION( "Decode2" )
   {
      ...
      int offset=0;
      uint8_t decoded[]={
         ,
      };
      
      for( int i1=0; i1< (int)( sizeof(strings) / sizeof(strings[0]) ); i1++ )
      {
         offset+=b64.decode( strings[i1], (lsize_t)strlen(strings[i1]), (uint8_t*)&dest1[offset], 200 );
      }
      
      REQUIRE ( memcmp( decoded, dest1, offset ) == 0 );
   }
   ...
   SECTION( "Cornercases decode2" )
   {
      ...
      const uint8_t decoding[] =
          {
            0x4d, 0x50, 0x00, 0x00, 0x00, 0x00, 0x50, 0x03, 0x00, 0x00, 0x00, 0xe5, 0x07, 0x07, 0x0a, 0x41, 
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x00, 0x00, 0x00, 0x00, 0x52, 0x05, 0x00, 0x01, 0x34, 0x00, 0x00, 0x00, 0xc8, 0xb8, 0xa3, 0x21, 
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 
            0x00, 0x00, 0x00, 0x00, 0x52, 0x05, 0x00, 0x02, 0x14, 0x00, 0x00, 0x00, 0x5d, 0x3f, 0xf0, 0x60, 
         };
      char dest1[200];
      
      for( int i1=0; i1< (int)( sizeof(strings) / sizeof(strings[0]) ); i1++ )
      {
         // Dest-size 0x10: Thats what the maintenance tools use
         REQUIRE ( b64.decode( strings[i1], (lsize_t)strlen(strings[i1]), (uint8_t*)&dest1[ i1 * 0xC ], 0x10 ) == 0xC );
      }
      
      REQUIRE ( memcmp( decoding, dest1, 0xC * 8 ) == 0 );
   }
